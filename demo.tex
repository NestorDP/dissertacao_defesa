...
\begin{frame}{Cyclone V SoC-FPGA}
	\begin{alertblock}{Hardware Processor System: Cortex A9 MPU}
		%\vspace{0.1cm}
		\begin{justify}
			A \textit{Microprocessor Unit Subsystem} (MPU) presentes SoCs da família Cyclone V incluem um Arm Cortex-A9 MPCore, com processador de uso geral de 32 bits com um ou dois núcleos.
		\end{justify}
		\begin{figure}[h]
			%\caption{{\footnotesize SoC genérico}}
			\begin{center}
				\includegraphics[scale=0.2]{imagens/mpusubsystem.png}\\
				{\footnotesize \textbf{Fonte:}}
			\end{center}
			\label{fig:cycloneV}
		\end{figure}
